              ...
              <div class="wrapper">
               ...
               >
                  ...
                  <div class="profile-card__cnt js-profile-cnt">
                    ...
                    <div class="profile-card__name">{s.Name}</div>
                    <div class="profile-card__txt">
                      Front-end Developer from <strong>Amman</strong>
                    </div>
                    <div class="profile-card__txt">
                      Email{" "}
                      <strong>
                    ...
                    <div class="profile-card__txt">
                      Lead Source <strong>{s.LeadSource || "N/A"}</strong>
                    </div>
                    <div class="profile-card__txt">
                      Active <strong>{s.Active__c}</strong>
                    </div>
                    <div class="profile-card__txt">
                      Created Date
                      <strong>
                    ...
                    <div class="profile-card-loc">
                      ...
                      <span class="profile-card-loc__txt">Jordan - Amman</span>
                    </div>
                    ...
                    <div class="profile-card-ctr">
                      <button class="profile-card__button button--blue js-message-btn" onClick={() => {
                            setOpen(true);
                            setEditVal(s);
                          }}>
                        Edit
                      </button>
                      {/* <button class="profile-card__button button--orange"  onClick={() => {
